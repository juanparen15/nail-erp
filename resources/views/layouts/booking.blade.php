...
<head>
    ...
    <meta property="og:image"        content="{{ url('/images/kate-nails-logo.png') }}">
    <meta property="og:image:secure_url" content="{{ url('/images/kate-nails-logo.png') }}">
    ...
    <meta name="twitter:image"       content="{{ url('/images/kate-nails-logo.png') }}">
